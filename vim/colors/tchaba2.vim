...
if &t_Co > 255
  ...
  highlight SpecialKey      ctermfg=111     ctermbg=235    cterm=none
  highlight NonText         ctermfg=111     ctermbg=235     cterm=none
  highlight Directory       ctermfg=180     ctermbg=235    cterm=none
  ...
  highlight VisualNOS       ctermfg=254     ctermbg=235    cterm=underline
  ...
  highlight Conceal         ctermfg=251     ctermbg=235    cterm=none
  highlight SpellBad        ctermfg=168     ctermbg=235    cterm=underline
  highlight SpellCap        ctermfg=80      ctermbg=235    cterm=underline
  highlight SpellRare       ctermfg=121     ctermbg=235    cterm=underline
  highlight SpellLocal      ctermfg=186     ctermbg=235    cterm=underline
  ...
  highlight Comment         ctermfg=244     ctermbg=235    cterm=none
  highlight Constant        ctermfg=180     ctermbg=235    cterm=none
  highlight Special         ctermfg=176     ctermbg=235    cterm=none
  highlight Identifier      ctermfg=80      ctermbg=235    cterm=none
  highlight PreProc         ctermfg=186     ctermbg=235    cterm=none
  highlight String          ctermfg=138     ctermbg=235    cterm=none
  highlight Number          ctermfg=186     ctermbg=235    cterm=none
  highlight Function        ctermfg=114     ctermbg=235    cterm=none
  highlight htmlEndTag      ctermfg=114     ctermbg=235    cterm=none
  highlight xmlEndTag       ctermfg=114     ctermbg=235    cterm=none
  if g:kolor_bold==0
    highlight ErrorMsg        ctermfg=168     ctermbg=235    cterm=none
    highlight Search          ctermfg=208     ctermbg=235    cterm=none
    highlight MoreMsg         ctermfg=121     ctermbg=235    cterm=none
    highlight ModeMsg         ctermfg=254     ctermbg=235    cterm=none
    highlight CursorLineNr    ctermfg=254     ctermbg=236     cterm=none
    highlight Question        ctermfg=80      ctermbg=235    cterm=none
    highlight WarningMsg      ctermfg=206     ctermbg=235    cterm=none
    highlight Statement       ctermfg=168     ctermbg=235    cterm=none
    highlight Type            ctermfg=141     ctermbg=235    cterm=none
    highlight Error           ctermfg=168     ctermbg=235    cterm=none
    highlight Todo            ctermfg=80      ctermbg=235    cterm=none
    highlight Keyword         ctermfg=168     ctermbg=235    cterm=none
    highlight Title           ctermfg=141     ctermbg=235    cterm=none
    if g:kolor_alternative_matchparen==0
    ...
    highlight ErrorMsg        ctermfg=168     ctermbg=235    cterm=bold
    highlight Search          ctermfg=208     ctermbg=235    cterm=bold
    highlight MoreMsg         ctermfg=121     ctermbg=235    cterm=bold
    highlight ModeMsg         ctermfg=254     ctermbg=235    cterm=bold
    highlight CursorLineNr    ctermfg=254     ctermbg=236     cterm=bold
    highlight Question        ctermfg=80      ctermbg=235    cterm=bold
    highlight WarningMsg      ctermfg=206     ctermbg=235    cterm=bold
    highlight Statement       ctermfg=168     ctermbg=235    cterm=bold
    highlight Type            ctermfg=141     ctermbg=235    cterm=bold
    highlight Error           ctermfg=168     ctermbg=235    cterm=bold
    highlight Todo            ctermfg=80      ctermbg=235    cterm=bold
    highlight Keyword         ctermfg=168     ctermbg=235    cterm=bold
    highlight Title           ctermfg=141     ctermbg=235    cterm=bold
    if g:kolor_alternative_matchparen==0
  ...
  if g:kolor_underlined==0
    highlight Underlined      ctermfg=111     ctermbg=235    cterm=none
  else
    highlight Underlined      ctermfg=111     ctermbg=235    cterm=underline
  endif
end

hi Normal ctermbg=none
hi NonText ctermbg=none
hi StatusText ctermbg=none
